...
def seed_database():
    ...
    try:
        ...
        c1 = Customer(name="Ananya Sharma", email="ananya.sharma@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9811223344", address="702 Prestige Towers, Indiranagar, Bangalore")
        c2 = Customer(name="Rahul Verma", email="rahul.verma@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9822334455", address="14 Palm Grove, Bandra West, Mumbai")
        c3 = Customer(name="Siddharth Malhotra", email="sid.malhotra@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9833112233", address="99 Jubilee Hills, Hyderabad")
        c4 = Customer(name="Priya Patel", email="priya.patel@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9833445566", address="56 Navrangpura, Ahmedabad")
        c5 = Customer(name="Vikram Singh", email="vikram.singh@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9844112233", address="12 Civil Lines, Jaipur")
        c6 = Customer(name="Aditya Kumar", email="aditya.kumar@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9844556677", address="204 DLF Phase 5, Gurgaon")
        c7 = Customer(name="Sneha Reddy", email="sneha.reddy@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9855112233", address="45 Park Street, Kolkata")
        c8 = Customer(name="Kavita Rao", email="kavita.rao@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9855667788", address="88 Anna Nagar, Chennai")
        c9 = Customer(name="Rohan Gupta", email="rohan.gupta@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9866112233", address="33 Koregaon Park, Pune")
        c10 = Customer(name="Meera Joshi", email="meera.joshi@example.com", hashed_password=hash_password("customerpass123"), role=UserRole.CUSTOMER.value, phone="+91-9877223344", address="102 Vasant Vihar, New Delhi")
        ...
        print("  Customer 1:   ananya.sharma@example.com / customerpass123")
